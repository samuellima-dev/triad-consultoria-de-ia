  ...
  return (
    <div className="min-h-screen font-sans text-text-main bg-page selection:bg-primary selection:text-white overflow-x-hidden pb-20 md:pb-0">
      ...
      <section id="contato" className="bg-page py-20 border-t border-slate-800 relative overflow-hidden">
        ...
        {/* Bottom Footer */}
        <div className="max-w-7xl mx-auto px-6 mt-20 border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-6 text-slate-500 text-sm">
          <div className="text-center md:text-left order-2 md:order-1">
            © 2026 Triad Consultoria de Automação, Dados e IA.
          </div>
          
          <div className="flex items-center gap-4 order-1 md:order-2">
            <a 
              href="https://www.instagram.com/triad_consultoria_de_ia/" 
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-slate-400 hover:text-primary transition-all duration-300"
            >
              <div className="p-2 rounded-full bg-slate-800 group-hover:bg-primary/10 border border-slate-700 group-hover:border-primary/30 transition-all">
